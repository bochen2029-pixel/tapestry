...
echo === compiling t_grades ===
cl %CFLAGS% "%ROOT%\src\tests\t_grades.cpp" /Fe:"%BIN%\t_grades.exe"
if errorlevel 1 (echo BUILD FAILED: t_grades & exit /b 1)
...
if /I "%1"=="test" (
  ...
  "%BIN%\t_grades.exe"
  if errorlevel 1 (echo ORACLES FAILED: t_grades & exit /b 1)
